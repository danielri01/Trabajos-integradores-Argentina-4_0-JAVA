...
public class Partido {
    ...
    public void CargarResultados (int NroPartido) throws IOException {
        ...
        this.equipo1 = campos[1].toUpperCase();
        this.equipo2 = campos[4].toUpperCase();
        this.golesEquipo1 = Integer.parseInt(campos[2]);
        this.golesEquipo2 = Integer.parseInt(campos[3]);
    }

    // Analiza en que posicion esta la X //
